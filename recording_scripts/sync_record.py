...
CHANNELS = 1
RATE = 44100
SAMPLES_TO_KEEP = 1_000_000
BYTES_PER_SAMPLE = 2
TOTAL_SAMPLES = SAMPLES_TO_DISCARD + SAMPLES_TO_KEEP
...
stream = p.open(format=FORMAT,
                channels=CHANNELS,
                rate=RATE,
                frames_per_buffer=TOTAL_SAMPLES,
                input=True,
...
raw_audio_bytes = stream.read(TOTAL_SAMPLES)
trimmed_audio_bytes = raw_audio_bytes[SAMPLES_TO_DISCARD * BYTES_PER_SAMPLE:]
#Print file
file_path = f"{location}_{user_or_adversary_answer}_AUDIO_DATA.bin"
